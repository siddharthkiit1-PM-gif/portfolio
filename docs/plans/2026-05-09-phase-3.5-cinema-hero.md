...
- [x] **Step 1: Update HeroBackground to route by tier**
...
- [x] **Step 2: Update HeroOrbFallback to render the portrait + halo**
...
- [x] **Step 3: Run full E2E to ensure no regressions**
...
- [x] **Step 1: Verify Vercel deploy is green**
...
- [x] **Step 2: Run Lighthouse desktop**
...
- [x] **Step 3: Run Lighthouse mobile**
